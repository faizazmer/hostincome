...
function FullLoader({ text }) {
  return (
    <div style={{ background: "#F8FAFC", minHeight: "100vh", fontFamily: "Inter, system-ui, sans-serif" }} className="flex flex-col items-center justify-center gap-4">
      <style>{`@keyframes hiBreathe{0%,100%{transform:scale(1);opacity:.85}50%{transform:scale(1.09);opacity:1}}`}</style>
      <img src={LOGO_ICON} alt="HostIncome" className="h-20 w-20" style={{ animation: "hiBreathe 1.5s ease-in-out infinite", filter: "drop-shadow(0 8px 20px rgba(109,40,217,0.25))", objectFit: "contain" }} draggable={false} />
  ...
  return (
    <div style={{ background: "#F8FAFC", minHeight: "100vh", fontFamily: "Inter, ui-sans-serif, system-ui, -apple-system, Segoe UI, Roboto, sans-serif", color: INK }}>
      <style>{`
        ...
        @keyframes hiBreathe { 0%,100% { transform: scale(1); opacity:.85 } 50% { transform: scale(1.09); opacity:1 } }
        .hi-breathe { animation: hiBreathe 1.5s ease-in-out infinite; filter: drop-shadow(0 8px 20px rgba(109,40,217,0.25)); }
...
const LOGO_ICON = "data:image/png;base64,";
